...
@Component({
  selector: 'app-higher-process-list',
  templateUrl: './higher-process-list.component.html',
  styleUrls: ['./higher-process-list.component.css']
})
export class HigherProcessListComponent implements OnInit {
