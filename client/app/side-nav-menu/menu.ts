import { AfterContentInit, Component, ContentChildren, EventEmitter, Input, Output, QueryList, ViewChildren } from '@angular/core';
...
export class SideNavMenuComponent {
    ...
    @ViewChildren(SideNavItemComponent) items: QueryList<SideNavItemComponent>;
